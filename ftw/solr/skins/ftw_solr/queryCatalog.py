...
# Added SearchableText, Description and Title so that we can delete these
# indexes in portal_catalog
indexes=catalog.indexes() + ['SearchableText', 'Description', 'Title']
query={}
show_query=show_all
second_pass = {}
